...
alias mvnf='mvn compile findbugs:findbugs findbugs:gui'
alias mvnctc="mvncist -TC"
alias mvnall="mvncist -TC;mvnt -Dmaven.test.failure.ignore=true"
...
function listMavenCompletions { 
     reply=(
        ...
        # common plugins
        deploy failsafe install site surefire checkstyle javadoc jxr pmd ant antrun archetype assembly dependency enforcer gpg help release repository source idea jetty cargo jboss tomcat tomcat6 tomcat7 exec versions war ear ejb android scm buildnumber nexus repository sonar license hibernate3 liquibase flyway gwt
	...
	# tomee
        ...
        # gwt
        gwt:browser gwt:clean gwt:compile gwt:compile-report gwt:css gwt:debug gwt:generateAsync gwt:help gwt:i18n gwt:mergewebxml gwt:resources gwt:run gwt:sdkInstall gwt:source-jar gwt:soyc gwt:test
